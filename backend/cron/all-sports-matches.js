const { getLeagues, getLeaguesMatches, saveSportsLeaguesMatchs, collectAllTheMatches, saveMatchesOdds, saveSureBets, saveDroppingOdds, saveResults } = require("./services");
...
module.exports = {
    ...
    start : async () => {
        ...
        const sports  = Object.keys(SPORT_MARKET);
        ...
        for (let index = 0; index < sports.length; index++) {
            ...
            try {
                const {sportMatches} = await collectAllTheMatches(sport);
        ...
        console.log('total All Matches',allSportsMatches.length)
        ...
        // calculate droping odds and surebets
        saveDroppingOdds();
        saveSureBets();
